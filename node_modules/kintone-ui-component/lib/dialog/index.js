...
let exportDialog;
(() => {
    exportDialog = window.customElements.get("kuc-dialog-1-17-0");
    if (exportDialog) {
        return;
    }
    ...
    __decorate([
        property()
    ], KucDialog.prototype, "header", void 0);
    __decorate([
        property()
    ], KucDialog.prototype, "container", void 0);
    __decorate([
        property({ type: Boolean })
    ], KucDialog.prototype, "footerVisible", void 0);
    __decorate([
        state()
    ], KucDialog.prototype, "_isOpened", void 0);
    __decorate([
        query(".kuc-dialog-1-17-0__dialog")
    ...
    window.customElements.define("kuc-dialog-1-17-0", KucDialog);
